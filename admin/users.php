            ...
            <tbody>
              <?php foreach ($users as $item): ?>
                <tr>
                  ...
                  <td><?= $item["role"]; ?></td>
                  <td>
                    <a href="userDelete.php?id=<?= $item["user_id"]; ?>" class="btn btn-sm btn-danger"
                      onclick="return confirm('Yakin ingin menghapus data users ?');"><i
                        class="fa fa-xs fa-solid fa-trash"></i></a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
