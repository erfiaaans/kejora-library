...
<body>
  ...
  <div class="mt-5 pt-2">
    <div class="hero mt-5">
      ...
      <p>Dashboard User Kejora Library - <span><?php echo date('l, d F Y'); ?></span></p>
    </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-4">
              <div class="card shadow">
                <a href="buku.php">
                  <img src="../assets/img/card/daftarBuku.png" class="card-img" alt="Daftar Buku">
                </a>
              </div>
            </div>
            <div class="col-md-6 mb-4">
              <div class="card shadow">
                <a href="peminjaman.php">
                  <img src="../assets/img/card/peminjaman.png" class="card-img" alt="Peminjaman">
                </a>
              </div>
            </div>
            <div class="col-md-6 mb-4">
              <div class="card shadow">
                <a href="pengembalian.php">
                  <img src="../assets/img/card/pengembalian.png" class="card-img" alt="Pengembalian">
                </a>
              </div>
            </div>
            <div class="col-md-6 mb-4">
  ...
  <footer class="bg-warning-subtle text-dark shadow-lg py-3 mt-auto">
